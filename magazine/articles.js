window.ASTERIA_ARTICLES = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        intro: "엄주범 단장은 크루의 컨디션과 실제 연습 시간을 함께 고려해 엔진 업그레이드를 결정했습니다.",
        tip: {
          kicker: "SKIPPER'S TIP · REINFORCEMENT",
          title: "엄주범 단장 팁",
          summary: "건축 분야 전문가인 엄주범 단장은 보강재를 고정하는 나사 가운데 선체와 접촉하는 부분에는 현장에서 ‘실리카’라고 부른 해양용 실리콘 실란트를 반드시 바르도록 지시했습니다.",
          items: [
  ...
  },
  {
    ...
    results: [
      { rank: "01", skipper: "고재영", badges: ["Skipper"], detail: "최중삼 · 이주환 · 채승범 · 이안" },
      { rank: "02", skipper: "이동준", badges: ["Skipper", "클럽 회장"], detail: "엄주범 · 김종명 · 이원희 · 박정일 · 게스트 정성안" },
      { rank: "03", skipper: "박정수", badges: ["Skipper", "우승 후보"], detail: "조윤호 · 김영철 · 김동천 · 게스트 김은진(레이디스)" }
    ],
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          "고재영 스키퍼와 최중삼, 이주환, 채승범, 이안이 첫 우승팀을 이뤘습니다. 이 결과는 출발 전의 예상만으로 실제 레이스에서 필요한 판단과 팀워크까지 예측하기 어렵다는 것을 보여줬습니다.",
    ...
    sections: [
      {
        ...
        body: [
          "이동준 회장과 김종명 회원은 출항 전에 토핑 리프트를 교체했습니다. 당장 고장이 난 것은 아니었지만 로프에서 경화와 노후의 기미가 보였습니다.",
      ...
      },
      {
        ...
        image: {
          ...
          caption: "윈치 없이 시트를 다루던 조윤호 회원에게 이동준 회장의 한마디가 날아왔습니다."
        },
        midImage: {
        ...
        body: [
          "처음에는 작은 스피네이커를 올린 줄 알았습니다. 조윤호 회원이 윈치 없이 트림을 돕고 있었는데 시트가 생각처럼 당겨지지 않았습니다. 그 모습을 본 이동준 회장이 “왜 이렇게 힘이 약해졌어?”라고 말했습니다.",
          "작은 스피네이커도 제대로 트림하지 못한다며 조윤호 회원이 잠시 구박을 받았습니다. 나중에 확인해 보니 펼친 것은 큰 스피네이커였습니다. 윈치 없이 손으로 컨트롤하기에는 원래 버거운 크기였습니다. 상황을 알게 된 이동준 회장도 머쓱해질 수밖에 없었습니다."
        ]
      },
      {
        ...
        body: [
          ...
          "크루들은 자신들이 해결할 수 있다고 말했습니다. 스키퍼를 맡은 엄주범 단장은 바로 다운을 지시하지 않고 문제를 풀 수 있도록 시간을 줬습니다. 그사이 어망은 계속 가까워졌습니다.",
      ...
      },
      {
        ...
        body: [
          "김종명 회원과 이주환 회원은 이날 바우를 맡았습니다. 두 사람 모두 멀미가 있었지만 스피네이커 운용에서 빠지지 않았습니다.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "오후 4시 무렵까지 김종명 회원과 이주환 회원의 두 척은 마리나 앞을 오갔습니다. 킬보트에서 맡은 포지션의 한계를 넘어보고 싶다면 레이저를 온전히 마스터해보는 것도 좋은 방법입니다. 아스테리아 회원은 아라마리나 ILCA 7 탑승권을 상시 25% 할인받습니다."
        ]
      }
    ]
  }
