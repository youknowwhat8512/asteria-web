window.ASTERIA_ARTICLES = [
  {
    ...
    facts: [
      ...
      { label: "Crew", value: "회장 DJ · 단장 JB · 국장 YH · Crew SB · Crew JM · Crew JH" },
    ...
    sections: [
      {
        ...
        body: [
          "9월 6일 오전 10시, 왕산마리나. 회장 DJ, 단장 JB, 국장 YH, Crew SB, Crew JM, Crew JH 여섯 명이 폴스타에 모였습니다. 오후 4시까지 이어질 2026 이순신컵 첫 연습이었습니다.",
  ...
  },
  {
    ...
    facts: [
      ...
      { label: "Crew", value: "단장 JB · 스키퍼 JW · 국장 YH" },
    ...
    sections: [
      {
        ...
        body: [
          "오후 5시 30분, 왕산마리나에서 슈팅스타가 출항했습니다. 단장 JB, 스키퍼 JW, 국장 YH 세 사람이 탔습니다. 처음으로 왕산 앞바다에서 쓰는 항해였습니다.",
  ...
  },
  {
    ...
    facts: [
      ...
      { label: "Team", value: "단장 JB · 국장 YH · Crew JM" },
    ...
    sections: [
      {
        ...
        body: [
          "단장 JB는 슈팅스타를 아라마리나 육상계류장에 올리고, 클럽 멤버들이 연습에 활용할 수 있도록 세 가지 튜닝을 준비했습니다. 이날 현장에는 국장 YH와 Crew JM이 함께했습니다.",
          "Crew JC(부산요트협회 부회장)의 지원을 받아 작업을 진행했습니다. 예정된 작업은 엔진 거치대 보강, 레이지백 설치, Calypso 초음파 풍향·풍속계 설치였습니다."
        ]
      },
      {
    ...
    sections: [
      {
        ...
        body: [
          ...
          "여분의 엔진오일은 없었다. 경고음 뒤 시동을 끈 애드 아스트라는 엔진의 힘을 쓸 수 없었고, 배를 움직일 수 있는 것은 약한 바람뿐이었다. 근처 섬과의 거리도 계속 지켜야 했다. 일곱 명은 곧 세 팀으로 나뉘었다. 단장 JB와 Crew JM은 주변 어선에 지원을 요청했다. 회장 DJ와 국장 YH는 발전기에서 오일을 빼 주 엔진으로 옮겼다. 정성안 국가대표 감독, 스키퍼 JY, Crew JH는 세일링을 이어 가며 배가 근처 섬에 더 가까워지지 않도록 했다.",
      ...
      },
      {
        ...
        body: [
          ...
          "단장 JB와 Crew JM은 배에서 밤을 보냈다. 단장 JB가 돌풍을 먼저 알아차려 계류줄을 조정한 뒤 잠을 설쳤다. 깊이 잠든 동행에게 연락이 닿지 않자 ‘기절 실종’이라는 농담도 나왔지만, 실제 사고는 아니었다."
        ]
      },
      {
        kicker: "ACT 02 · 04",
        ...
        body: [
          ...
          "야간 항해는 두 팀의 교대로 운영됐다. 1팀은 회장 DJ, 국장 YH, 스키퍼 JY로 구성됐다. 2팀은 정성안 국가대표 감독, Crew JM, Crew JH, 단장 JB가 맡았다. 한 팀이 확인한 항로와 장비 정보는 다음 팀으로 이어졌다.",
      ...
      },
      {
        ...
        body: [
          "전기공학 박사인 Crew JM은 장비 매뉴얼을 파악한 뒤 기기 안의 기능을 하나씩 점검하고 최적화했다. 기존에는 오토파일럿을 단순 침로 유지에 주로 사용했지만, 설정을 조정한 뒤에는 바람의 방향을 기준으로 항해하거나 Navionics의 경로를 따라갈 수 있도록 B&G 시스템을 연동했다.",
      ...
      },
      {
        ...
        body: [
          "항로 경험자인 단장 JB와 회장 DJ는 Navionics로 항로를 설계하고, 야간 당번과 배에서 밤을 보내는 요박의 방식을 나눴다. 초행인 Crew JM, Crew JH, 국장 YH는 화면을 읽고 장비 정보를 공유하며 실제 항로를 따라갔다.",
  ...
  },
  {
    ...
    raceFlow: [
      ...
      },
      {
        ...
        label: "The Upset",
        title: "경험이 만든 이변",
        text: "우승 후보였던 스키퍼 JS 팀은 3위. 첫 컵은 스키퍼 JY 팀에게 돌아갔다.",
        image: "/images/mag-club-cup-2026-downwind-duel.jpeg",
        alt: "흰 스피니커를 펼친 두 대의 J/70이 나란히 항해하는 모습"
      }
    ],
    results: [
      { rank: "01", skipper: "스키퍼 JY", badges: [], detail: "Crew JS · Crew JH · Crew SB · Crew A" },
      { rank: "02", skipper: "회장 DJ", badges: [], detail: "단장 JB · Crew JM · Crew WH · Crew JI · 게스트 정성안" },
      { rank: "03", skipper: "스키퍼 JS", badges: ["우승 후보"], detail: "국장 YH · Crew YC · Crew DC · 게스트 Crew EJ(레이디스)" }
    ],
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          "대회 전 가장 유력한 우승 후보는 스키퍼 JS 팀이었습니다. 그러나 최종 결과는 3위였습니다. 회장 DJ 팀이 2위에 올랐고, 예상 밖의 스키퍼 JY 팀이 우승을 차지했습니다.",
      ...
      },
      {
        ...
        body: [
          "스키퍼 JY와 Crew JS, Crew JH, Crew SB, Crew A가 첫 우승팀을 이뤘습니다. 이 결과는 출발 전의 예상만으로 실제 레이스에서 필요한 판단과 팀워크까지 예측하기 어렵다는 것을 보여줬습니다.",
    ...
    sections: [
      {
        ...
        body: [
          "회장 DJ와 Crew JM은 출항 전에 토핑 리프트를 교체했습니다. 당장 고장이 난 것은 아니었지만 로프에서 경화와 노후의 기미가 보였습니다.",
      ...
      },
      {
        ...
        body: [
          "Crew JM과 Crew JH는 이날 바우를 맡았습니다. 두 사람 모두 멀미가 있었지만 스피네이커 운용에서 빠지지 않았습니다.",
      ...
      },
      {
        ...
        body: [
          "단장 JB가 스키퍼를 맡았고 국장 YH가 피트맨, 스키퍼 JS가 지브 트리머, 회장 DJ가 메인 트리머로 탔습니다. Crew JM과 Crew JH는 바우맨으로 참가했습니다."
        ]
      }
    ],
    gallery: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "오후 4시 무렵까지 Crew JM과 Crew JH의 두 척은 마리나 앞을 오갔습니다. 킬보트에서 맡은 포지션의 한계를 넘어보고 싶다면 레이저를 온전히 마스터해보는 것도 좋은 방법입니다. 아스테리아 회원은 아라마리나 ILCA 7 탑승권을 상시 25% 할인받습니다."
        ]
      }
    ]
  }
