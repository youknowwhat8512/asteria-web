window.ASTERIA_ARTICLES = [
  ...
  },
  {
    ...
    lead: "왕산 앞바다에 백파가 보이던 오후였습니다. 바람은 12~13노트, 거스트는 16~18노트까지 올라왔습니다. 이날 식사 자리에서 가장 오래 이야기한 것은 최고 속도 9노트가 아니라, 스피네이커 트러블이 발생한 상태에서 어망을 만났던 순간이었습니다.",
    ...
    facts: [
      ...
      { label: "Boat Speed", value: "풍상 7+ kt · 풍하 최고 9 kt" },
      { label: "Crew", value: "6명" }
    ],
    sections: [
      {
      ...
      },
      {
        ...
        image: {
          ...
          caption: "윈치 없이 시트를 다루던 조윤호에게 이동준 회장님의 한마디가 날아왔습니다."
        },
        midImage: {
        ...
        body: [
          "처음에는 작은 스피네이커를 올린 줄 알았습니다. 조윤호가 윈치 없이 트림을 돕고 있었는데 시트가 생각처럼 당겨지지 않았습니다. 그 모습을 본 이동준 회장님이 “왜 이렇게 힘이 약해졌어?”라고 말했습니다.",
          "작은 스피네이커도 제대로 트림하지 못한다며 조윤호가 잠시 구박을 받았습니다. 나중에 확인해 보니 펼친 것은 큰 스피네이커였습니다. 윈치 없이 손으로 컨트롤하기에는 원래 버거운 크기였습니다. 상황을 알게 된 이동준 회장님도 머쓱해질 수밖에 없었습니다."
        ]
      },
      {
        ...
        body: [
          ...
          "크루들은 자신들이 해결할 수 있다고 말했습니다. 엄주범 스키퍼는 바로 다운을 지시하지 않고 문제를 풀 수 있도록 시간을 줬습니다. 그사이 어망은 계속 가까워졌습니다.",
      ...
      },
      {
        ...
        body: [
          "김종명과 이주환은 이날 바우를 맡았습니다. 두 사람 모두 멀미가 있었지만 스피네이커 운용에서 빠지지 않았습니다.",
      ...
      },
      {
        ...
        body: [
          "아스테리아는 1시간 57분 동안 10.4해리를 항해했습니다. 풍상에서는 일반 세일로 7노트 이상, 풍하에서는 최고 9노트를 기록했습니다.",
          ...
          "그날 식사 자리에서는 최고 속도 9노트보다, 급박한 상황에서도 스키퍼와 크루가 차분하게 어망을 빠져나온 일이 더 오래 화제에 올랐습니다."
        ]
      },
      {
        ...
        heading: "여섯 명이 맡은 자리",
        body: [
          "엄주범이 스키퍼를 맡았고 조윤호가 피트맨, 박정수가 지브 트리머, 이동준이 메인 트리머로 탔습니다. 김종명과 이주환은 바우맨으로 참가했습니다."
        ]
      }
    ],
    gallery: [
