window.ASTERIA_ARTICLES = [
  {
    slug: "hwandonghae-cup-2026-j70",
    url: "/magazine/hwandonghae-cup-2026-j70/",
    category: "Regatta",
    title: "No Excuses",
    titleKo: "고수는 도구를 탓하지 않는다",
    publishedAt: "2026-09-18",
    eventDate: "2026-09-13",
    image: "/images/mag-hwandonghae-2026-hero-podium-award.jpeg",
    imageAlt: "제5회 환동해컵 국제요트대회 J70 오픈부 2위 시상 패널과 트로피를 들고 단상에 선 팀 아스테리아 크루",
    heroNote: "5TH HWANDONGHAE CUP · J70 OPEN · 2ND · POHANG · 11–13 SEP 2026",
    shape: "wide",
    excerpt: "마스트가 부러졌다 이어 붙은 요트, 낡고 찢어진 메인세일. 팀 아스테리아는 주어진 장비를 탓하는 대신 세팅을 다시 잡았고, 총점 9점으로 종합 2위에 올랐습니다. 매뉴얼을 벗어난 튜닝 한 번과, 그것을 받쳐낸 크루들의 이야기입니다.",
    lead: "2026년 9월 11일부터 13일까지, 포항 영일대해수욕장 앞바다에서 제5회 환동해컵 국제요트대회가 열렸습니다. J70 클래스 여섯 척이 여섯 번의 레이스를 치렀고, 아스테리아는 세일번호 05번 팀 아스테리아로 나섰습니다.",
    pullQuote: "매뉴얼은 매뉴얼일 뿐이다. 매뉴얼을 익히는 건 초보에서 중급까지고, 그 이상 가려면 응용을 할 줄 알아야 한다.",
    facts: [
      { label: "Event", value: "2026 제5회 환동해컵 국제요트대회" },
      { label: "Date", value: "2026.09.11–09.13" },
      { label: "Venue", value: "포항 영일대해수욕장" },
      { label: "Class", value: "J70 Open · 6 boats · 6 races" },
      { label: "Sail No.", value: "05 · 팀 아스테리아" },
      { label: "Result", value: "종합 2위 · 총점 9.0" },
      { label: "Skipper", value: "최명규 팀장" },
      { label: "Crew", value: "LDJ 핏맨 · KJM 세일·트래블러 · 송 크루" }
    ],
    sections: [
      {
        kicker: "01 / Standing",
        heading: "총점 9점, 종합 2위로 경기를 마쳤습니다",
        body: [
          "결과는 총점 9점, 종합 2위였습니다.",
          "팀 아스테리아는 평일에 각자의 일을 하고 주말에 바다로 나오는 사람들로 꾸려졌습니다. 이번에 탄 크루 중 요트를 업으로 하는 사람은 없습니다. 클럽에서 연습하고 이론을 공부해 온 시간이 이 팀이 가진 전부였습니다.",
          "여섯 번의 레이스 내내 상위권을 지켰고, 마지막 두 레이스는 1위로 끝냈습니다."
        ],
        endImage: {
          src: "/images/mag-hwandonghae-2026-race-sea.jpeg",
          width: 1600,
          height: 1200,
          alt: "포항 영일대 앞바다에 여러 척의 요트가 흩어져 떠 있는 레이스 해상 전경",
          caption: "바람을 기다리는 경기 해역. 대회 내내 바람이 약했습니다.",
          layout: "natural"
        }
      },
      {
        kicker: "02 / The Boat",
        heading: "손에 쥔 것은 낡은 요트였습니다",
        image: {
          src: "/images/mag-hwandonghae-2026-j70-yard.jpeg",
          width: 1600,
          height: 1200,
          alt: "대회장 육상 계류장에 트레일러 위로 나란히 올라선 J70 세 척",
          caption: "대회장 육상 계류장에 올라선 J70들. 출전 요트는 현장에서 배정받습니다.",
          layout: "natural"
        },
        body: [
          "배정받은 요트는 마스트가 한 번 부러졌다 이어 붙인 것이었습니다. 규격보다 마스트가 짧았고, 짧은 마스트는 같은 바람에서 덜 나간다는 뜻입니다. 지급받은 메인세일도 낡았고 찢어진 곳까지 있었습니다.",
          "스키퍼 최명규 팀장이 대회장에서 가장 먼저 한 일은 불평이 아니라 튜닝이었습니다."
        ]
      },
      {
        kicker: "03 / The Recipe",
        heading: "매뉴얼을 벗어난 세팅, 최 팀장의 레시피",
        galleryLayout: "pair",
        gallery: [
          {
            src: "/images/mag-hwandonghae-2026-mast-stepping.jpeg",
            width: 1200,
            height: 1600,
            alt: "육상 계류장 트레일러 위 J70의 갑판에 올라서서 마스트를 세우는 크루와 이를 올려다보는 크루",
            caption: "계류장에서 마스트를 세우는 작업. 세팅은 물에 나가기 전 육상에서 시작됩니다.",
            layout: "portrait"
          },
          {
            src: "/images/mag-hwandonghae-2026-mast-tuning.jpeg",
            width: 1200,
            height: 1600,
            alt: "육상에 세워둔 J70의 마스트와 스테이를 아래에서 올려다본 모습",
            caption: "출항 전 마스트와 스테이를 다시 잡는 작업. 이 세팅이 대회를 갈랐습니다.",
            layout: "portrait"
          }
        ],
        body: [
          "J70에는 제조사가 배포하는 튜닝 매뉴얼이 있습니다. 바람 세기별로 스테이를 얼마나 당길지 숫자로 정리된 표이고, 보통은 그 표의 기준값에 맞춰 세팅하고 물에 나갑니다.",
          "최 팀장은 그 기준에서 벗어났습니다. 포어스테이는 기준보다 더 주고 사이드스테이는 반대로 더 내렸습니다. 마스트를 세우는 각도와 돛에 힘이 걸리는 중심 위치까지 여러 곳을 조금씩 손봤습니다. 매뉴얼이 전제한 요트와 지금 발밑의 요트가 다르다는 판단이었습니다.",
          "어느 매뉴얼에도 없는 조합입니다. 오랜 시간 요트를 타며 자기 손으로 찾아낸, 그만의 비밀 레시피입니다.",
          "그렇게 세팅한 요트는 빠른 요트가 되지는 못했습니다. 대신 바람 쪽으로 더 높이 붙었습니다. 속도로 겨루는 대신 코스로 겨루는 요트가 된 것입니다."
        ]
      },
      {
        kicker: "04 / Interview",
        heading: "핏맨 LDJ에게 현장 인터뷰를 했습니다",
        image: {
          src: "/images/mag-hwandonghae-2026-interview.jpeg",
          width: 900,
          height: 1600,
          alt: "대회장 그늘막 아래 테이블 위에 놓인 2026 제5회 환동해컵 국제요트대회 J70 오픈부 2nd Place 트로피와 아스테리아 폴로를 입은 크루",
          caption: "대회장 그늘막 아래. 트로피를 사이에 두고 경기 이야기를 들었습니다.",
          layout: "compact-portrait"
        },
        midImage: null,
        body: [
          "<strong>— 요트 상태를 보고 어떤 생각이 들었나요.</strong><br>조건만 보면 좋지 않았어요. 마스트는 짧고 세일은 낡았고. 그런데 팀장님이 튜닝을 다시 잡았어요. 매뉴얼 기준에서 벗어난 세팅이었는데, 물에 나가보니 우리가 위로 더 붙더라고요.",
          "<strong>— 이번 대회에서 가장 크게 남은 게 뭡니까.</strong><br>솔직히 메달보다 튜닝이에요. 그동안 우리는 매뉴얼대로만 맞췄거든요. 이번엔 그 과정을 옆에서 다 봤습니다. 숫자만 받은 게 아니라 뭘 보고 왜 그렇게 손대는지, 한 경기 뛰고 나서 뭘 근거로 다시 만지는지를 같이 겪은 거죠. 예전에 부산에서 이유도 모르고 뒤처졌던 적이 있는데, 그게 왜 그랬는지 이번에 알았어요.",
          "<strong>— 핏맨 자리는 어떤 일을 합니까.</strong><br>마크 돌 때 몇 초에 다 몰려요. 백라인 놓는 순서, 핼리어드 당기는 속도, 하나만 어긋나도 요트가 그 자리에서 섭니다. 이건 연습 말고는 방법이 없어요. 대회 앞두고도 세일 올리고 내리는 것만 계속 했습니다.",
          "<strong>— 경기를 마치고 소감이 있을까요?</strong><br>경기 중에 팀장님이 저희 보고 선수들 90% 정도 퍼포먼스는 나온다고 하시더라고요. 그동안 클럽에서 연습하고 공부한 게 헛되지 않았구나 싶었어요. 그 말이 제일 기분 좋았습니다."
        ]
      },
      {
        kicker: "05 / Interview",
        heading: "트리머 KJM에게도 현장 인터뷰를 했습니다",
        image: {
          src: "/images/mag-hwandonghae-2026-kjm-trophy.jpeg",
          width: 1600,
          height: 1200,
          alt: "대회장 해변에서 제5회 환동해컵 J70 오픈부 2위 트로피와 시상 패널을 양손에 들어 올린 크루",
          caption: "시상을 마치고. 트로피와 패널을 들어 올렸습니다."
        },
        midImage: null,
        body: [
          "<strong>— 경기를 치르면서 팀이 달라진 게 느껴졌나요.</strong><br>라운드를 거듭할수록 팀빌딩이 좋아졌어요. 성적도 3위, 2위, 1위로 올라갔고요. 서로 조언을 주고받고 그걸 그대로 받아들이면서 시너지가 났습니다.",
          "<strong>— 이번 세팅은 어떻게 나온 겁니까.</strong><br>최 팀장님이 이전 대회에서 상대 팀의 퍼포먼스를 보시고 몇 주간 연구를 거듭한 방법이었어요. 대회 전까지 극비리에 진행했는데, 제가 목소리가 커서 거의 누설할 뻔했습니다.",
          "<strong>— 대회장 분위기는 어땠나요.</strong><br>대회 내내 경쟁 팀들과 이야기를 나누면서 즐겁게 지냈어요. 1일차 뒤풀이 때 평택팀 박기동 감독님께서 저희 팀에 좋은 평가를 주셔서 다들 자신감을 얻었습니다.",
          "<strong>— 어떤 이야기였습니까.</strong><br>\"자이빙을 하면 앞서 가던 다른 팀들은 요트 한두 척 길이만큼 따라잡는데, 이 팀은 따라잡히지 않아서 깜짝 놀랐다\"고 하셨어요. 그 말을 듣고 선수들 표정이 달라졌습니다."
        ]
      },
      {
        kicker: "06 / Day Two",
        heading: "실수가 한 번도 없었던 날",
        image: {
          src: "/images/mag-hwandonghae-2026-race-crew.jpeg",
          width: 1200,
          height: 1600,
          alt: "레이스 중 요트 레일에 나란히 앉아 균형을 잡고 있는 크루들",
          caption: "요트가 가장 빠른 자세를 유지하도록 체중과 트림을 계속 조정합니다.",
          layout: "compact-portrait"
        },
        body: [
          "토요일은 바람이 거의 없었습니다. 가벼운 바람에서는 작은 실수 하나가 그대로 순위가 됩니다. 이날 팀은 한 번도 실수하지 않았습니다. 최 팀장은 3위 정도만 지키려던 생각을 경기 중에 바꿨습니다.",
          "인원은 단출했습니다. 최 팀장이 스키퍼와 메인세일, LDJ가 핏맨, KJM이 세일 핸들링과 메인 트래블러를 맡았습니다. 여기에 최 팀장과 몇 차례 합을 맞춰본 송 크루가 함께 탔습니다. 요트의 밸런스를 잡는 일은 LDJ와 KJM이 계속 맡았습니다.",
          "첫 레이스는 튜닝 직후라 감각이 붙지 않아 3위였습니다. 한 경기 뛰자마자 다시 조정했고 2·3레이스는 연속 2위였습니다. 그리고 이 첫 3점은 대회가 끝날 때 버린 점수가 됐습니다. 팀 아스테리아는 자기 최악의 성적이 3위인 대회를 치른 셈입니다."
        ]
      },
      {
        kicker: "07 / Final Day",
        heading: "뒤로 밀린 뒤, 마지막 두 레이스를 1위로 끝냈습니다",
        image: {
          src: "/images/mag-hwandonghae-2026-helm-focus.jpeg",
          width: 1026,
          height: 1072,
          alt: "레이스 중 요트 뒤쪽에 앉아 틸러 익스텐션과 시트를 쥔 채 앞을 살피는 크루",
          caption: "바람과 코스를 읽는 시간. 이 판단이 마지막 두 레이스를 갈랐습니다.",
          layout: "compact-portrait"
        },
        body: [
          "일요일에도 바람이 오지 않아 한 시간을 기다렸습니다.",
          "출발선에서 일이 벌어졌습니다. 진로가 막혀 피하려고 세일을 내렸다 올리는 사이 마크에 닿았습니다. 규정대로 페널티 턴을 한 바퀴 돌고 나니 순위는 한참 뒤였습니다.",
          "이때 최 팀장이 한 말은 순위를 포기하는 말이 아니었습니다. \"실수만 안 하면 따라잡는다.\" 그는 코스를 읽고 풍하 마크에서 여러 척이 한 덩어리로 겹칠 것이라고 봤습니다. 그대로 됐습니다.",
          "팀은 자이빙을 연달아 걸어 안쪽을 잡고 스타보드 태크로 진입해 우선권을 가졌습니다. 규칙에 맞게 안쪽 자리를 지키며 마크를 돌아 나왔고, 그 한 구간에서 순위를 크게 되돌렸습니다. 스키퍼 혼자 만들 수 없는 장면입니다. 한 번만 버벅였어도 기회는 지나갔습니다.",
          "이날 팀 아스테리아는 5레이스와 6레이스를 모두 1위로 끝냈습니다. 페널티로 시작한 날을 연속 1위로 마무리한 것입니다."
        ]
      },
      {
        kicker: "08 / No Excuses",
        heading: "도구를 탓하지 않는다는 것",
        tip: {
          kicker: "Race Record",
          title: "팀 아스테리아 레이스 기록",
          summary: "여섯 레이스 중 가장 나쁜 하나를 버리는 방식입니다. 팀이 버린 점수는 첫 레이스의 3점이었습니다.",
          items: [
            { label: "R1", value: "3위 (버린 점수)" },
            { label: "R2", value: "2위" },
            { label: "R3", value: "2위" },
            { label: "R4", value: "3위" },
            { label: "R5", value: "1위" },
            { label: "R6", value: "1위 · 총점 9.0 · 종합 2위" }
          ]
        },
        image: {
          src: "/images/mag-hwandonghae-2026-podium.jpeg",
          width: 1600,
          height: 1200,
          alt: "시상식 단상에서 J70 오픈부 입상 팀들이 나란히 선 모습",
          caption: "시상식 단상에 오른 팀 아스테리아. J70 오픈부 종합 2위입니다.",
          layout: "natural"
        },
        body: [
          "낡은 요트를 받아 들고 종합 2위로 경기를 마쳤습니다. 장비를 탓할 이유는 충분했지만, 팀이 대회 내내 한 일은 주어진 요트를 읽고 세팅을 고쳐 잡는 것이었습니다. 최 팀장을 보며 고수는 도구를 탓하지 않는다는 말이 떠오르는 대회였습니다.",
          "다음 무대는 이순신장군배입니다."
        ],
        endImage: {
          src: "/images/mag-hwandonghae-2026-trophy.jpeg",
          width: 1600,
          height: 1200,
          alt: "2026 제5회 환동해컵 국제요트대회 2nd Place 라고 새겨진 투명 아크릴 트로피",
          caption: "2026 제5회 환동해컵 국제요트대회 J70 오픈부 준우승 트로피.",
          layout: "natural"
        }
      }
    ]
  },
  {
    ...
    shape: "wide",
    excerpt: "2026 이순신컵을 앞둔 첫 연습이었습니다. 바람이 제법 불어 작은 스피네이커를 골랐고, 계류장에서 올리고 내리기를 반복한 뒤 오후에 바다로 나갔습니다. 4개의 포지션이 첫 합을 맞추던 세 시간, 그리고 로프 한 가닥이 하루를 일찍 마무리 지었습니다.",
    ...
    facts: [
      ...
      { label: "Crew", value: "회장 DJ · 단장 JB · 국장 YH · CSB · KJM · LJH" },
    ...
    sections: [
      {
        ...
        body: [
          "9월 6일 오전 10시, 왕산마리나. 회장 DJ, 단장 JB, 국장 YH, CSB, KJM, LJH 여섯 명이 폴스타에 모였습니다. 오후 4시까지 이어질 2026 이순신컵 첫 연습이었습니다.",
      ...
      },
      {
        ...
        heading: "오후, 바다 위에서 4개의 포지션이 첫 합을 맞추었습니다",
        explainer: {
          kicker: "CREW GUIDE · POSITIONS",
          title: "스피네이커를 올릴 때 함께 움직이는 4개의 포지션",
          summary: "스피네이커 한 장을 올리고 다루는 동안 여러 포지션이 동시에 움직입니다. 맡은 로프와 장비가 서로 다르기 때문에, 한 포지션의 조절이 다른 포지션의 감각까지 바꿉니다.",
          items: [
          ...
          note: "이날 연습의 핵심도 여기에 있었습니다. 4개의 포지션이 각자 조금씩 바꾼 조절이 서로에게 어떻게 전해지는지 확인하는 것이었습니다."
        },
        body: [
  ...
  },
  {
    ...
    facts: [
      ...
      { label: "Crew", value: "단장 JB · YJW · 국장 YH" },
    ...
    sections: [
      {
        ...
        body: [
          "오후 5시 30분, 왕산마리나에서 슈팅스타가 출항했습니다. 단장 JB, YJW, 국장 YH 세 사람이 탔습니다. 처음으로 왕산 앞바다에서 쓰는 항해였습니다.",
      ...
      },
      {
        ...
        body: [
          ...
          "단장 JB가 장비를 마련한 이유도 여기에 있었습니다. 아마추어 중심의 클럽이 실력을 높이려면 포지션별 집중 훈련이 필요하다고 보았습니다. 한 포지션은 데이터를 보며 여러 시도를 하고, 다른 포지션은 일정한 움직임을 유지해야 무엇이 달라졌는지 비교할 수 있기 때문입니다.",
          ...
          "모두가 스키퍼의 표정보다 태블릿을 먼저 확인하는 모습을 두고, 국장 YH가 스키퍼를 ‘테선장님’이라고 부르기 시작했습니다. 별명은 웃음에서 시작됐지만, 그날부터 팀이 함께 실력을 키워 갈 기준이 하나 더 생겼습니다."
        ]
      },
      {
  ...
  },
  {
    ...
    image: "/images/mag-shootingstar-tuning-2026-hardstand-hero-face-blurred-v2.jpeg",
    ogImage: "/images/og-shootingstar-tuning-2026-anonymized.jpg",
    ...
    facts: [
      ...
      { label: "Team", value: "단장 JB · 국장 YH · KJM" },
    ...
    sections: [
      {
        ...
        body: [
          "단장 JB는 슈팅스타를 아라마리나 육상계류장에 올리고, 클럽 멤버들이 연습에 활용할 수 있도록 세 가지 튜닝을 준비했습니다. 이날 현장에는 국장 YH와 KJM이 함께했습니다.",
          "KJC(부산요트협회 부회장)의 지원을 받아 작업을 진행했습니다. 예정된 작업은 엔진 거치대 보강, 레이지백 설치, Calypso 초음파 풍향·풍속계 설치였습니다."
        ]
      },
      {
        ...
        intro: "단장 JB는 크루의 컨디션과 실제 연습 시간을 함께 고려해 엔진 업그레이드를 결정했습니다.",
        tip: {
          kicker: "SKIPPER'S TIP · REINFORCEMENT",
          title: "단장 JB 팁",
          summary: "건축 분야 전문가인 단장 JB는 보강재를 고정하는 나사 가운데 선체와 접촉하는 부분에는 현장에서 ‘실리카’라고 부른 해양용 실리콘 실란트를 반드시 바르도록 지시했습니다.",
          items: [
            { label: "WHY IT MATTERS", value: "금속 나사와 선체는 진동에 반응하는 특성이 서로 달라, 접촉부에 충격이 반복되면 손상이 누적될 수 있습니다." },
            { label: "MANDATORY STEP", value: "실란트 층은 서로 다른 진동 특성에서 생기는 충격을 완충하고 틈을 메워, 선체 손상이 시작될 위험을 줄입니다. 그래서 실란트 도포는 선택 사항이 아닌 필수 공정입니다." }
          ]
        },
        body: [
          "슈팅스타의 기존 4.9마력 엔진을 9.9마력으로 업그레이드하기에 앞서 엔진 거치대를 보강했습니다. 왕산 앞바다에서는 어망을 피해 연습 수역까지 멀리 이동해야 합니다. 조수간만의 차가 크거나 바람이 강한 날에는 기존 엔진으로 이동하는 시간이 길어져, 크루가 연습 전부터 지치거나 연습 후 복귀에 큰 부담을 느낄 수 있었습니다."
        ]
      },
      {
        kicker: "03 / Lazy Bag",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "여분의 엔진오일은 없었다. 경고음 뒤 시동을 끈 애드 아스트라는 엔진의 힘을 쓸 수 없었고, 배를 움직일 수 있는 것은 약한 바람뿐이었다. 근처 섬과의 거리도 계속 지켜야 했다. 일곱 명은 곧 세 팀으로 나뉘었다. 단장 JB와 KJM은 주변 어선에 지원을 요청했다. 회장 DJ와 국장 YH는 발전기에서 오일을 빼 주 엔진으로 옮겼다. 정성안 국가대표 감독, GJY, LJH는 세일링을 이어 가며 배가 근처 섬에 더 가까워지지 않도록 했다.",
      ...
      },
      {
        ...
        body: [
          ...
          "단장 JB와 KJM은 배에서 밤을 보냈다. 단장 JB가 돌풍을 먼저 알아차려 계류줄을 조정한 뒤 잠을 설쳤다. 깊이 잠든 동행에게 연락이 닿지 않자 ‘기절 실종’이라는 농담도 나왔지만, 실제 사고는 아니었다."
        ]
      },
      {
        kicker: "ACT 02 · 04",
        ...
        body: [
          ...
          "야간 항해는 두 팀의 교대로 운영됐다. 1팀은 회장 DJ, 국장 YH, GJY로 구성됐다. 2팀은 정성안 국가대표 감독, KJM, LJH, 단장 JB가 맡았다. 한 팀이 확인한 항로와 장비 정보는 다음 팀으로 이어졌다.",
      ...
      },
      {
        ...
        body: [
          "전기공학 박사인 KJM은 장비 매뉴얼을 파악한 뒤 기기 안의 기능을 하나씩 점검하고 최적화했다. 기존에는 오토파일럿을 단순 침로 유지에 주로 사용했지만, 설정을 조정한 뒤에는 바람의 방향을 기준으로 항해하거나 Navionics의 경로를 따라갈 수 있도록 B&G 시스템을 연동했다.",
      ...
      },
      {
        ...
        body: [
          "세연정은 국가 명승 ‘보길도 윤선도 원림’을 대표하는 공간이다. 정자와 연못, 바위와 숲이 하나의 풍경을 이룬다. 이곳은 모험을 시작하기 전부터 단장 JB가 꼭 들러야 한다고 꼽은 필수 코스였다. 크루 대부분은 세연정을 잘 몰랐지만, 직접 와 보고서야 왜 꼭 들러야 하는지 알게 됐다.",
      ...
      },
      {
        ...
        body: [
          "항로 경험자인 단장 JB와 회장 DJ는 Navionics로 항로를 설계하고, 야간 당번과 배에서 밤을 보내는 요박의 방식을 나눴다. 초행인 KJM, LJH, 국장 YH는 화면을 읽고 장비 정보를 공유하며 실제 항로를 따라갔다.",
          "단장 JB와 회장 DJ에게 항로를 읽는 법과 요트 운항법을 전수받았고, 정성안 감독에게는 코드제로 세일뿐 아니라 세일링 퍼포먼스에 대해서도 배울 수 있는 시간이었다.",
      ...
      },
      {
        ...
        body: [
          ...
          "마지막에는 무사 항해를 축하했다. 회장 DJ가 “앞에 그물 있어요!”라고 농담하자 모두 웃었고, 기쁜 마음으로 축하 원샷을 하며 3박 4일의 항해를 마무리했다."
        ]
      }
    ],
    gallery: []
  },
  {
    ...
    lead: "유력한 우승 후보는 3위에 그쳤고, 예상 밖의 팀이 첫 컵을 차지했습니다. 2026년 6월 7일 아라마리나에서 열린 ASTERIA CLUB CUP 2026. 아스테리아의 첫 자체 대회는 예상보다 치열했고, 최종 순위는 경기 전 전망과 달랐습니다.",
    pullQuote: "예상은 출발선에서 끝났다. 마지막까지 승부를 가른 것은 경험이었다.",
    facts: [
      { label: "Event", value: "ASTERIA CLUB CUP 2026" },
      { label: "Date", value: "2026.06.07" },
      { label: "Venue", value: "Ara Marina" },
      { label: "Race", value: "11:00 — 16:00" },
      { label: "Fleet", value: "J/70 × 3" },
      { label: "Conditions", value: "22–25°C · 비 없음" }
    ],
    raceFlow: [
      {
        step: "01",
      ...
      },
      {
        ...
        label: "The Upset",
        title: "경험이 만든 이변",
        text: "우승 후보였던 PJS 팀은 3위. 첫 컵은 GJY 팀에게 돌아갔다.",
        image: "/images/mag-club-cup-2026-downwind-duel.jpeg",
        alt: "흰 스피니커를 펼친 두 대의 J/70이 나란히 항해하는 모습"
      }
    ],
    results: [
      { rank: "01", skipper: "GJY", badges: [], detail: "CJS · LJH · CSB · LA" },
      { rank: "02", skipper: "회장 DJ", badges: [], detail: "단장 JB · KJM · LWH · PJI · 게스트 정성안" },
      { rank: "03", skipper: "PJS", badges: ["우승 후보"], detail: "국장 YH · KYC · KDC · 게스트 KEJ(레이디스)" }
    ],
    sections: [
      {
        ...
        body: [
          ...
          "중요한 것은 규모가 아니었습니다. 다른 대회에 참가하는 것을 넘어, 아스테리아가 직접 대회를 열어 서로 경쟁한 첫 번째 자체 대회라는 점이었습니다."
        ]
      },
      {
        ...
        body: [
          "대회 전 가장 유력한 우승 후보는 PJS 팀이었습니다. 그러나 최종 결과는 3위였습니다. 회장 DJ 팀이 2위에 올랐고, 예상 밖의 GJY 팀이 우승을 차지했습니다.",
          "경기 전의 예상은 물 위에서 통하지 않았습니다. 레이스가 시작되자 세 팀 모두 물 위에서 실력을 증명해야 했습니다."
        ]
      },
      {
        ...
        body: [
          ...
          "나이는 승부의 치열함을 누그러뜨리지 못했습니다. 오히려 끝까지 자리를 다투는 모습 자체가 첫 Club Cup의 가장 큰 재미가 됐습니다."
        ]
      },
      {
        ...
        body: [
          "GJY와 CJS, LJH, CSB, LA가 첫 우승팀을 이뤘습니다. 이 결과는 출발 전의 예상만으로 실제 레이스에서 필요한 판단과 팀워크까지 예측하기 어렵다는 것을 보여줬습니다.",
          "백전노장의 경험은 무시할 수 없었습니다. 이것이 첫 대회가 남긴 가장 선명한 결론이었습니다."
        ]
      },
      {
        kicker: "05 / After The Race",
        heading: "첫 기록은 다음 레이스를 부른다",
        body: [
          "레이스는 오후 4시에 끝났지만, Club Cup의 열기는 오후 7시까지 이어졌습니다. 세 척으로 시작한 작은 대회는 아스테리아가 클럽 안에서 자체 레이스 문화를 시작한 첫 기록이 됐습니다.",
          "이날은 다음 Club Cup에서 모두가 되돌아볼 출발점이 됐습니다. 그 장면은 2026년 6월 7일 아라마리나에 남았습니다."
        ]
      }
    ],
    gallery: [
  ...
  {
    slug: "wangsan-afternoon-sail-2026",
    url: "/magazine/wangsan-afternoon-sail-2026/",
    category: "Club Sailing",
    title: "Between the Big Spinnaker and the Fishing Net",
    titleKo: "큰 스피네이커와 어망 사이",
    publishedAt: "2026-07-25",
    eventDate: "2026-07-25",
    image: "/images/mag-wangsan-2026-hero.jpeg",
    ogImage: "/images/og-wangsan-afternoon-sail-2026.jpg",
    imageAlt: "왕산 앞바다를 항해하며 로프와 휠을 다루는 세 명의 크루",
    heroNote: "WANGSAN MARINA · 10.4 NM · 1H 57M",
    shape: "wide",
    excerpt: "큰 스피네이커의 클루 시트가 빠졌고 전방에는 어망이 있었습니다. 아스테리아 크루는 세일을 내리지 않고 상황을 해결했습니다.",
    lead: "왕산 앞바다에 백파가 보이던 오후였습니다. 바람은 12~13노트, 거스트는 16~18노트까지 올라왔습니다.",
    pullQuote: "“왜 이렇게 힘이 약해졌어?” 작은 스피네이커인 줄 알았지만, 펼친 것은 큰 스피네이커였습니다.",
    facts: [
      { label: "Date", value: "2026.07.25" },
      { label: "Venue", value: "왕산마리나 인근 해역" },
      { label: "Distance", value: "10.4 NM" },
      { label: "Sail Time", value: "1시간 57분" },
      { label: "Wind", value: "남남서풍→남서풍 · 12–13 kt" },
    ...
    sections: [
      {
        ...
        midImage: {
          ...
          caption: "토핑 리프트 교체를 마친 뒤 마스트 주변 장비와 세일을 정리했습니다.",
          position: "center 55%"
        },
        body: [
          "회장 DJ와 KJM은 출항 전에 토핑 리프트를 교체했습니다. 당장 고장이 난 것은 아니었지만 로프에서 경화와 노후의 기미가 보였습니다.",
          "아스테리아는 레이싱 요트인 만큼 장비에서 작은 이상이 보이면 문제가 생기기 전에 교체하고 있습니다. 두 사람은 새 토핑 리프트를 설치한 뒤 출항 준비를 마쳤습니다."
        ]
      },
      {
        kicker: "02 / The Bigger Sail",
        heading: "작은 스피네이커가 아니었습니다",
        image: {
          src: "/images/mag-wangsan-2026-sheet-work.jpeg",
          alt: "보트 위에서 두 명의 크루가 로프를 잡고 세일링 장비를 조작하는 모습",
          caption: "윈치 없이 시트를 다루던 국장 YH에게 회장 DJ의 한마디가 날아왔습니다."
        },
        midImage: {
          src: "/images/mag-wangsan-2026-sail-detail.jpeg",
          alt: "푸른 하늘 아래 붉은 세일 커버와 흰 세일, 붐과 여러 로프가 보이는 모습",
          caption: "푸른 하늘 아래 이어진 세일과 리깅.",
          position: "center 48%"
        },
        body: [
          "처음에는 작은 스피네이커를 올린 줄 알았습니다. 국장 YH가 윈치 없이 트림을 돕고 있었는데 시트가 생각처럼 당겨지지 않았습니다. 그 모습을 본 회장 DJ가 “왜 이렇게 힘이 약해졌어?”라고 말했습니다.",
          "작은 스피네이커도 제대로 트림하지 못한다며 국장 YH가 잠시 구박을 받았습니다. 나중에 확인해 보니 펼친 것은 큰 스피네이커였습니다. 윈치 없이 손으로 컨트롤하기에는 원래 버거운 크기였습니다. 상황을 알게 된 회장 DJ도 머쓱해질 수밖에 없었습니다."
        ]
      },
      {
        ...
        body: [
          ...
          "크루들은 자신들이 해결할 수 있다고 말했습니다. 이날 스키퍼를 맡은 단장 JB는 바로 다운을 지시하지 않고 문제를 풀 수 있도록 시간을 줬습니다. 그사이 어망은 계속 가까워졌습니다.",
          "크루들은 스피네이커의 바람을 빼고 지브처럼 한쪽으로 모은 뒤 침로를 틀었습니다. 결국 세일을 내리지 않은 채 어망을 비껴갔으며, 통과한 뒤에는 다시 바람을 받아 항해를 이어갔습니다."
        ]
      },
      {
        kicker: "04 / Bowmen",
        ...
        body: [
          "KJM과 LJH는 이날 바우를 맡았습니다. 두 사람 모두 멀미가 있었지만 스피네이커 운용에서 빠지지 않았습니다.",
          "스피네이커를 올리는 호이스트부터 운용 중 정리, 마지막 드롭까지 바우에는 계속 작업이 생깁니다. 두 사람은 몸이 불편한 상태에서도 세일을 내릴 때까지 맡은 작업을 마쳤습니다."
        ]
      },
      {
        ...
        midImage: {
          ...
          caption: "손목형 항해 기기 화면에도 항해 중 SOG 7.2가 남았습니다.",
          position: "center 72%"
        },
        body: [
          "아스테리아는 1시간 57분 동안 10.4해리를 항해했습니다. 풍상에서는 일반 세일로 7노트 이상, 풍하에서는 최고 11.4노트를 기록했습니다.",
          "항해를 마친 뒤 식사 자리에서는 클럽을 처음 시작했을 때와 비교해 실력이 많이 늘었다는 이야기가 나왔습니다. 백파가 보이는 조건에서도 운용에 큰 문제가 없었고, 클루 시트가 빠진 채 어망을 만났을 때도 예전처럼 허둥대지 않았기 때문입니다.",
          "그날 식사 자리에서는 최고 속도 11.4노트보다, 급박한 상황에서도 스키퍼와 크루가 차분하게 어망을 빠져나온 일이 더 오래 화제에 올랐습니다."
        ]
      },
      {
        ...
        body: [
          "단장 JB가 스키퍼를 맡았고 국장 YH가 피트맨, PJS가 지브 트리머, 회장 DJ가 메인 트리머로 탔습니다. KJM과 LJH는 바우맨으로 참가했습니다."
        ]
      }
    ],
    gallery: [
      {
        ...
        caption: "왕산 앞바다에 남은 10.4해리의 항적.",
        layout: "record"
      }
    ]
  },
  {
    slug: "ilca-7-one-sail-one-sailor",
    url: "/magazine/ilca-7-one-sail-one-sailor/",
    category: "Dinghy Knowledge",
    title: "Beyond Your Position",
    titleKo: "킬보트에서 포지션의 한계를 넘고 싶다면",
    publishedAt: "2026-07-26",
    eventDate: "2026-07-26",
    image: "/images/mag-ilca7-ara-two-boats-wide.jpeg",
    ogImage: "/images/og-ilca7-one-sail-one-sailor.jpg",
    imageAlt: "아라마리나 수면에 흰 세일을 올린 ILCA 7 두 척이 떨어져 항해하는 모습",
    heroNote: "ARA MARINA · ILCA 7 × 2 · 26 JUL 2026",
    shape: "wide",
    excerpt: "킬보트에서는 헬름, 트리머, 바우맨이 일을 나눕니다. 자기 포지션 밖에서 일어나는 일까지 이해하고 싶다면, 레이저를 온전히 마스터해보는 것도 좋은 방법입니다.",
    lead: "7월 26일 오전 11시쯤, 아라마리나 부잔교에 ILCA 7 두 척이 나란히 섰습니다. 폭염 안전문자가 도착한 날이었습니다.",
    sections: [
      {
        kicker: "01 / Before Launch",
        heading: "레이저에서는 포지션을 나눌 수 없습니다",
        image: {
          src: "/images/mag-ilca7-ara-dock-rigging.jpeg",
          alt: "구명조끼를 입은 두 사람이 파란 부잔교에서 흰 딩기와 세일 주변을 살피는 모습",
          caption: "출항 전 아라마리나 부잔교. 두 회원이 ILCA 7 두 척과 함께 준비하고 있습니다.",
          position: "center 42%"
        },
        midImage: {
          src: "/images/mag-ilca7-ara-cockpit-check.jpeg",
          alt: "모자와 구명조끼를 착용한 사람이 부잔교에 놓인 흰 딩기 안쪽을 살피는 모습",
          caption: "흰 선체와 마스트 주변을 살피는 준비 장면입니다.",
          position: "center 58%"
        },
        body: [
          "레이저(Laser, 현재 공식 클래스명 ILCA)는 메인세일 한 장을 쓰는 1인승 딩기입니다. 한 손은 러더를 잡고 다른 손은 메인시트를 다룹니다. 배가 기울면 몸을 옮겨 균형을 잡습니다. 침로가 흔들리거나 세일의 힘이 빠졌을 때 원인을 찾아 고치는 사람도 자기 자신입니다.",
          "러더가 무거워지는 순간, 시트에 걸리는 힘, 몸을 옮겼을 때 선체가 다시 일어서는 반응이 한꺼번에 손과 몸으로 들어옵니다. 킬보트에서 여러 포지션이 나눠 느끼는 신호를 레이저에서는 한 사람이 모두 받습니다."
        ]
      },
      {
        kicker: "02 / From Dinghy to Keelboat",
        heading: "자기 역할 밖의 움직임이 보이기 시작합니다",
        image: {
        ...
        body: [
          ...
          "레이저에서는 메인시트를 바꾸고, 몸을 옮기고, 러더의 반응을 느끼는 일이 한 흐름으로 이어집니다. 이 경험을 쌓고 킬보트에 돌아가면 다른 포지션의 콜이 왜 필요한지, 자신의 동작이 배 전체에 어디까지 영향을 주는지 이해하기 쉬워집니다."
        ]
      },
      {
        kicker: "03 / Racecraft",
        ...
        midImage: {
          ...
          caption: "아라마리나 수면을 함께 오가는 ILCA 7 두 척. 같은 배가 나란히 있을수록 보트 스피드와 코스 선택의 차이가 잘 보입니다.",
          position: "center 72%",
          layout: "portrait"
        },
        body: [
          "레이저를 온전히 마스터하려면 혼자 출항하고 돌아오는 수준에서 한 걸음 더 나아가야 합니다. 바람이 달라져도 보트 스피드를 유지하고, 시선을 보트 밖에 둔 채 다음 선택을 앞서 준비해야 합니다.",
          "스타트 라인까지 남은 거리와 시간, 바람이 들어오는 쪽, 앞배가 남긴 더티 에어, 마크에서 생길 오버랩까지. 레이저 레이싱에서는 이 판단을 대신해 줄 택티션이 없습니다. 배를 빠르게 모는 동안 다음 장면도 스스로 골라야 합니다.",
          "코스를 잘못 고르면 같은 보트가 금세 멀어지고, 좋은 바람을 먼저 잡으면 작은 차이가 그대로 거리가 됩니다. 장비나 역할 분담에 가려졌던 판단의 결과가 선명합니다. 스키퍼가 아니어도 레이저를 타볼 이유가 생기는 대목입니다."
        ]
      },
      {
        kicker: "04 / One Design",
        heading: "같은 보트로 겨루기 때문에 더 잘 보입니다",
        midImage: {
          src: "/images/mag-ilca7-ara-sail-crew.jpeg",
          alt: "아라마리나 육상에 세워진 레이저 세일과 보트 주변에 여러 사람이 모여 있는 모습",
          caption: "세일 번호와 Laser 클래스 표식이 남아 있는 ILCA 7. 현재 공식 클래스명은 ILCA지만 기존 공인 레이저도 같은 클래스에서 이어집니다.",
          layout: "portrait"
        },
        body: [
          "ILCA는 장비 규격을 엄격하게 맞춘 원디자인 클래스입니다. ILCA 4·6·7은 길이 4.23m, 폭 1.37m의 같은 선체를 쓰고 세일과 하부 마스트를 바꿉니다. 세일 면적은 각각 약 4.7㎡, 5.76㎡, 7.06㎡입니다. 이날 두 회원이 탄 배는 가장 큰 리그인 ILCA 7이었습니다.",
          "이 보트는 1969년에 설계됐고 레이저라는 이름으로 널리 알려졌습니다. 1974년 첫 세계선수권이 열렸고, Laser Standard는 1996년 애틀랜타 올림픽부터 남자 1인승 종목으로 쓰였습니다. 현재 공식 클래스명은 ILCA입니다. 이름이 바뀐 뒤에도 기존 공인 레이저는 같은 클래스에서 계속 탑니다. 반세기가 지난 지금도 같은 규격의 배가 출발선에 모입니다."
        ]
      },
      {
        kicker: "05 / Member Benefit",
        heading: "레이저를 온전히 마스터해보는 것도 방법입니다",
        body: [
          "오후 4시 무렵까지 KJM과 LJH의 두 척은 마리나 앞을 오갔습니다. 킬보트에서 맡은 포지션의 한계를 넘어보고 싶다면 레이저를 온전히 마스터해보는 것도 좋은 방법입니다. 아스테리아 회원은 아라마리나 ILCA 7 탑승권을 상시 25% 할인받습니다."
        ]
      }
    ]
  }
