window.ASTERIA_ARTICLES = [
  {
    ...
    results: [
      { rank: "01", skipper: "고재영", detail: "최중삼 · 채승범 · 이안" },
      { rank: "02", skipper: "이동준", detail: "클럽 회장 · 엄주범 · 김종명 · 이원희 · 이주환 · 게스트 정성안" },
      { rank: "03", skipper: "박정수", detail: "우승 후보 · 조윤호 · 김영철 · 김동천 · 게스트 김은진(레이디스)" }
    ],
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          "고재영 스키퍼와 최중삼, 채승범, 이안이 첫 우승팀을 이뤘습니다. 이 결과는 출발 전의 예상만으로 실제 레이스에서 필요한 판단과 팀워크까지 예측하기 어렵다는 것을 보여줬습니다.",
