    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "건축 분야 전문가인 엄주범 단장은 보강재를 고정하는 나사 가운데 선체와 접촉하는 부분에는 현장에서 ‘실리카’라고 부른 해양용 실리콘 실란트를 반드시 바르도록 지시했습니다. 금속 나사와 선체는 진동에 반응하는 특성이 서로 달라, 접촉부에 충격이 반복되면 손상이 누적될 수 있다는 판단이었습니다.",
          "실란트 층은 서로 다른 진동 특성에서 생기는 충격을 완충하고 접촉부의 틈을 메워, 선체 손상이 시작되기 전에 위험을 줄이는 역할을 합니다. 엄 단장은 이 도포 과정을 선택 사항이 아닌 필수 공정으로 포함해야 한다고 강조했습니다."
        ]
      },
      {
        kicker: "03 / Lazy Bag",
